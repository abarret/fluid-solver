function lap = LaplacianSideY(w,dx,dy)
% Computes the Laplacian of a side centered quantity (y-side) using second 
% order finite differences.
% Inputs:
%   w  : side centered (y-side) scalar valued function.
